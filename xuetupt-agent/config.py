...
class _Config:
    ...
    kb_dir: Path = field(default_factory=lambda: Path(__file__).parent / "knowledge_base" / "data")
    embedding_cache_dir: Path = field(default_factory=lambda: Path(__file__).parent / "knowledge_base" / "embeddings")
